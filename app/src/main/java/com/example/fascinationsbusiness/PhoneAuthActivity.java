...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        mVerificationInProgress = savedInstanceState
                .getBoolean(KEY_VERIFY_IN_PROGRESS);
    }
    ...
    private void updateUI(int uiState, FirebaseUser user,
        ...
        switch (uiState) {
            ...
            case STATE_CODE_SENT:
                ...
                //enableViews(mVerifyButton, mResendButton, mPhoneNumberField,
                //mVerificationField);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.buttonStartVerification:
                ...
                String number = "+91" + mPhoneNumberField.getText().toString();
                startPhoneNumberVerification(number);
                break;
            case R.id.buttonResend:
                resendVerificationCode(mPhoneNumberField.getText().toString(),
                        mResendToken);
                break;
